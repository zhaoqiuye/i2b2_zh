...
i2b2.UI.cfg = {
	...
	loginHeaderText : "i2b2 登录",  /* [Default: "i2b2 Login"] Text in the header bar of the login box */
	loginUsernameText : "用户名:", /* [Default: "Username:"] Text for the username input of the login box */
	loginDefaultUsername : "demo", /* [Default: "demo"] Default text inside the username input */
	loginPasswordText : "密码:", /* [Default: "Password:"] Text for the password input of the login box */
